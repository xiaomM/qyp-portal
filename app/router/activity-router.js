...
module.exports = function(app){
    ...
    app.get(prefix + '/:activityId/signup',MemberController.oAuth2,MemberController.readyMember, Controller.index, Controller.getDetail, Controller.signup);
    ...
    app.get(prefix + '/lists',MemberController.oAuth2,MemberController.readyMember, Controller.lists);
